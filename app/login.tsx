        ...
        <View style={styles.card}>
          ...
          <View style={styles.hintBox}>
            <Text style={styles.hintText}>
              <Text style={{ fontWeight: "700" }}>Tip:</Text> You can use any email + password you signed up with.
            </Text>
          </View>
          ...
          <View style={styles.switchRow}>
            <Text style={styles.switchText}>New to PetSOS?</Text>
...
const bg = "#0f172a"; // solid background (slate-900)
...
const styles = StyleSheet.create({
  ...
  hintBox: { backgroundColor: "rgba(37,99,235,0.08)", borderColor: "rgba(37,99,235,0.2)", borderWidth: 1, padding: 10, borderRadius: 10, marginTop: 6 },
  hintText: { color: primary, textAlign: "center", fontSize: 12 },
